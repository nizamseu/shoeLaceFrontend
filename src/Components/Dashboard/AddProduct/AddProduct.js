...
console.log(data);
    ...
    return (
        ...
        <input  {...register("title",{ required: true ,minLength:30})}  placeholder='Product Title' /> <br />
       ...
       flexDirection:{xs:'column',sm:'column',md:'column',lg:'row'}
            ...
            <input style={{width:'100%',marginRight:'10px'}} type="number" {...register("price", { min: 10, max: 10000 })} placeholder='Price' /> <br />
           {errors.price && <span className='error'>Price  Between 10 to 99999</span>} 
        
          <input style={{width:'100%',}} type="text" {...register("brand", { required: true })} placeholder='Brand Name' /> <br />
          {errors.brand && <span className='error'>Brand is Requre</span>}
          
       </Box>

        <textarea {...register("description", { required: true },{ min: 150 } )} placeholder='Description' /> <br/>
      {errors.description && <p className='error'>Minimum 150 Character</p>}
